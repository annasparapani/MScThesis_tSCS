...
//
#ifndef RTW_HEADER_myTMSI_AnnaSparapani_h_
#define RTW_HEADER_myTMSI_AnnaSparapani_h_
#include <math.h>
#include <float.h>
#include <string.h>
#ifndef myTMSI_AnnaSparapani_COMMON_INCLUDES_
# define myTMSI_AnnaSparapani_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "fusbi.h"
#endif                                 // myTMSI_AnnaSparapani_COMMON_INCLUDES_

#include "myTMSI_AnnaSparapani_types.h"
...
} D_Work_myTMSI_AnnaSparapani;

// Parameters (auto storage)
struct Parameters_myTMSI_AnnaSparapani_ {
  ...
  int32_T TMSI_p5[12];                 // Expression: int32(ch)
                                       //  Referenced by: '<Root>/TMSI'
...
struct tag_RTM_myTMSI_AnnaSparapani {
...
extern "C" {
  ...
  extern Parameters_myTMSI_AnnaSparapani myTMSI_AnnaSparapani_P;
...
// Block signals (auto storage)
extern BlockIO_myTMSI_AnnaSparapani myTMSI_AnnaSparapani_B;

// Block states (auto storage)
extern D_Work_myTMSI_AnnaSparapani myTMSI_AnnaSparapani_DWork;
...
extern "C" {
  ...
  extern void myTMSI_AnnaSparapani_initialize(void);
  extern void myTMSI_AnnaSparapani_step(void);
  extern void myTMSI_AnnaSparapani_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_myTMSI_AnnaSparapani *const myTMSI_AnnaSparapani_M;
...
//
//  '<Root>' : 'myTMSI_AnnaSparapani'
//  '<S1>'   : 'myTMSI_AnnaSparapani/Subsystem1'
//  '<S2>'   : 'myTMSI_AnnaSparapani/Subsystem2'
//  '<S3>'   : 'myTMSI_AnnaSparapani/Subsystem3'
//  '<S4>'   : 'myTMSI_AnnaSparapani/Subsystem4'
//  '<S5>'   : 'myTMSI_AnnaSparapani/Subsystem5'

#endif                                 // RTW_HEADER_myTMSI_AnnaSparapani_h_
